...
class ZoomFridgeSpider(scrapy.Spider):
    ...
    def parse_fridge(cls, response):
        ...
        cooler_info_loader = fridge_loader.nested_css(':nth-child(2) tr')
        cooler_info_loader.add_css('door', ':nth-child(2) .table-val a::text')
        cooler_info_loader.add_css('special_resources', ':nth-child(3) .table-val span::text')
        cooler_info_loader.add_css('basic_resources', ':nth-child(4) .table-val span::text')
        cooler_info_loader.add_css('external_dispenser', ':nth-child(5) .table-val span::text')
        cooler_info_loader.add_css('door_material', ':nth-child(6) .table-val span::text')
        cooler_info_loader.add_css('shelf_material', ':nth-child(7) .table-val span::text')
