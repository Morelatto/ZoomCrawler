...
class ZoomStoveSpider(scrapy.Spider):
    ...
    def parse_oven(cls, response):
        ...
        details_loader = oven_loader.nested_css(':nth-child(2) tr')
        details_loader.add_xpath('tipo', './/*[text()[contains(.,"Tipo de Fogão")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('bocas', './/*[text()[contains(.,"Número de Bocas")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('funcionamento_mesa', './/*[text()[contains(.,"Funcionamento da Mesa")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('acendimento_mesa', './/*[text()[contains(.,"Tipo de Acendimento da Mesa")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('acabamento_inox', './/*[text()[contains(.,"Acabamento Inox")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('material_mesa', './/*[text()[contains(.,"Material da Mesa")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('funcoes_mesa', './/*[text()[contains(.,"Funções e Recursos da Mesa")]]/../../td[@class="table-val"]//text()')
        details_loader.add_xpath('tipo_grade', './/*[text()[contains(.,"Tipo de Grade")]]/../../td[@class="table-val"]//text()')
